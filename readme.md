...
## Featured Projects
- [VinylManager](https://github.com/mechagr/vinyl-manager) – Manage and track vinyl record collections (C#)  
- [ZXManager](https://github.com/mechagr/zx-manager) – Organise ZX Spectrum game collections (C#)  
- [Netflix MBTI Analyser](https://github.com/mechagr/netflix-mbti) – MBTI personality type based on Netflix viewing history (C#)
